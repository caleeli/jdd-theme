...
namespace Coredump\JddTheme;

use App\Menu;
use App\User;
use Illuminate\Support\ServiceProvider;
use Coredump\JddTheme\Console\Commands\UpdatePackage;

class PackageServiceProvider extends ServiceProvider
{
    const PluginName = 'coredump/jdd-theme';
    ...
    public function boot()
    {
        ...
        app('config')->push('plugins.css', '/modules/' . self::PluginName . '/jdd-package.css');
